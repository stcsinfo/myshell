...
docker login docker-privat.$domain_intra_ba
...
docker tag $nom_imatge_local docker-privat.$domain_intra_ba/proves/$nom_imatge_nexus
docker push docker-privat.$domain_intra_ba/proves/$nom_imatge_nexus